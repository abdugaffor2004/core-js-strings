...
function removeFirstOccurrences(str, value) {
  ...
  // ðÅÒ×ÙÊ slice ÏÔÒÅÚÁÅÔ ÏÔ ÓÔÒÏËÉ ÓÉÍ×ÏÌÙ ÏÔ 0-ÇÏ ÉÎÄÅËÓÁ ÄÏ ÎÕÖÎÏÇÏ ÎÁÍ (ÎÅ ×ËÌÀÞÁÑ).
  // úÁÔÅÍ ÐÒÉÂÁ×ÌÑÅÍ ÏÓÔÁÌØÎÕÀ ÞÁÓÔØ ËÏÔÏÒÁÑ ÎÁÞÉÎÁÅÔÓÑ Ó ÎÕÖÎÏÇÏ ÉÎÄÅËÓÁ ÔÁËÖÅ ×ËÌÀÞÁÑ ÄÌÉÎÎÕ ÓÔÒÏËÉ ÏÔ ËÏÔÏÒÏÊ ÍÙ ÈÏÔÉÍ ÉÚÂÁ×ÉÔØÓÑ.
}
...
function sumOfCodes(str) {
  const array = str === undefined || str === null ? 0 : str.split('');
  let codeSum = 0;
...
function countVowels(str) {
  ...
  return vowelsSum; // íÏÑ ÒÅÁÌÉÚÁÃÉÑ

  // const vowels =
  //   /['a', 'e', 'i', 'o', 'u', 'y', 'A', 'E', 'I', 'O', 'U', 'Y']/gi;
  // let foundVowelsArray;
  // str === undefined ? 0 : (foundVowelsArray = str.match(vowels));
  // if (foundVowelsArray === null || str === undefined) {
  //   return 0;
  // }
  // return foundVowelsArray.length; // òÅÁÌÉÚÁÃÉÑ ÐÏÓÌÅ ÐÏÉÓËÁ ÂÏÌÅÅ ÜÆÆÅËÔÉ×ÎÏÇÏ ÒÅÛÅÎÉÑ.
}
